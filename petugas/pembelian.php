...
<table class="table">
  ...
  <tbody>
   ...
   while($d = mysqli_fetch_array($data)){
    ...
    <tr>
     ...
     <td>
      <a class="btn btn-info btm-sm" href="detail_pembelian.php?PelangganID=<?php echo $d['PelangganID']; ?>">Detail</a>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <h1 class="modal-tittle fs-5" id="exampleModalLabel">Tambah Data</h1>
 ...
 <div class="modal fade" id="hapus-data<?php echo $d['PelangganID']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
        <h1 class="modal-tittle fs-5" id="exampleModalLabel">Hapus Data</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      ...
      <form action="proses_pembelian.php" method="post">
        <div class="modal-body">
          ...
          <div class="from-group">
            ...
            <input type="hidden" name="TanggalPenjualan" class="form-control" value="<?php echo date('Y-m-d') ?>">
        </div>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Keluar</button>
